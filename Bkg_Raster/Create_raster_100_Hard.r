...
ggplot() +
  geom_sf(data = shp) + theme_minimal()
...
ggplot() +
  geom_sf(data = shp_water) +  # nolint: trailing_whitespace_linter.
  theme_minimal()
...
shp_5109_02_03  <-  shp_proj %>%
  filter(vannområd=="5109-02" | vannområd=="5109-03")
...
plot_area(shp_5109_02_03, shp_water)
...
extent <- sf::st_bbox(shp_5109_02_03)
...
ggsave(p2, file=paste0(folder_output_od, "/plot_Hard_raster100_2.png"), width=10, height=10, units="cm", dpi=300)

  # Save the results as .rds files
  saveRDS(shp_5109_02_03, file = paste0(folder_output_od, "shp_5109_100.rds"))
