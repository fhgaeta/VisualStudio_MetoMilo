...
file_path_gdb <- "C:/Users/FEG/OneDrive - NIVA/METOMILO_OneDrive/GIS Data/Ecological components data/22. Species_habitats and areas of conservation/22.2 Fiskeridir_Nasjonale laksefjord/Fiskeridir_Nasjonale laksefjor.shp"
...
for (i in seq_along(species_list)) {
  ...
  file_out <- paste0(local_folder, "15.1_", sanitize_filename(habitat), "_Salten.csv")
