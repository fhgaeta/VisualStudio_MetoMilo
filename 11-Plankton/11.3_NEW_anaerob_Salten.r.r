...
# Read data layers
shp_path <- paste0(
  "C:/Users/FEG/OneDrive - NIVA/METOMILO_OneDrive/GIS Data/Ecological components data/11. Plankton/11.3 Anaerobiske forhold paa bunnen/Fiskeridir_Fjorder Salten/Fiskeridir_Fjorder Salten.shp"
)
...
for (i in seq_along(shp_hard_low$kategori)) {
  ...
  file_out <- paste0(local_folder, "11.3_", layer, "_Salten", ".csv")
