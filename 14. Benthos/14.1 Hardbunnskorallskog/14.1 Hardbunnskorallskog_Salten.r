#plot single area - Salten 14.1 Hardbunnskorallskog
...
ggplot() +
  ...
  theme_minimal() +
  labs(subtitle = "Hardbunnskorallskog - Salten")
...
ggsave(p1, filename = paste0(folder_output_od, "14.1 Hardbunnskorallskog_Salten_vectorial_", shp_area_3$vannregion[1], ".png"),
...
ggsave(p2, filename = paste0(folder_output_od, "14.1 CoralGarden_Salten_vectorial_", shp_area_3$vannregion[1], ".png"),
             dpi = 300, height = 20, width = 20, units = "cm", bg = "white")
...
ggsave(p3, filename = paste0(folder_output_od, "14.1 SMHObservations_Salten_vectorial_", shp_area_3$vannregion[1], ".png"),
             dpi = 300, height = 20, width = 20, units = "cm", bg = "white")
...
for (species_to_rasterize in species_list) {
 ...
 shp_octoral_inters_selection <- shp_octoral_inters %>%
  ...
  ggsave(
    ...
    filename = paste0(
      folder_output_od, 
      "14.1 Hardbunnskorallskog_Salten_raster_200_", 
