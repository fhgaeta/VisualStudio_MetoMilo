#plot single area - Hardanger 14.9 Rekeutbredelse
...
file_path_shp <- "C:/Users/FEG/OneDrive - NIVA/METOMILO_OneDrive/GIS Data/Ecological components data/15. Crustacea/15.2 Dypvannsreke/Dypvannsreke.shp"
...
for (i in seq_along(species_list)) {
  ...
  file_out <- paste0(local_folder, "14.9_", species, "_Hardanger", ".csv")
