...
#plot the results
p1 <- ggplot() +
  geom_sf(data=shp_5104, fill="#05bdeb", colour=NA, alpha=0.8) +
...
ggsave(p1, filename=paste0(folder_output_od, "10.2_Seabirds_Jeren_vectorial", shp_area_1$vannregion[1], ".png"),
...
?sf::st_intersects
  ...
  rasterized_species <- terra::rasterize(
    shp_birds_1_filtered, rast_100_jeren, field = "speciesnorwegianname", fun = "count"
  )
  ...
  ggsave(
    ...
    filename = paste0(
      folder_output_od, 
      "10.2.Seabirds_Jeren_raster_100_", 
