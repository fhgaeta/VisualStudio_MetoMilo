...
p <- ggplot() +
  ...
  geom_sf(data=shp_birds_3, aes(colour=speciesnorwegianname)) +
  coord_sf() +
...
?sf::st_intersects
  ...
  ggsave(
    ...
    filename = paste0(
      folder_output_od, 
      "10.2.Seabirds_Salten_raster_200_", 
